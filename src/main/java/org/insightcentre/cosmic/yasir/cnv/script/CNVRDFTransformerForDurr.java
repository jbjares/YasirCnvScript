...
public class CNVRDFTransformerForDurr {
		...
		if (file.isFile()) {
			...
			while ((record = reader.readNext()) != null) {
				...
				if (rowCount == 0) {
					...
					sb.append("ID_Sample;");
					sb.append("ID_Tumour;");
					sb.append("Primary_Site;");
					sb.append("Site_Subtype;");
					sb.append("Primary_Histology;");
					sb.append("Histology_Subtype;");
					sb.append("MUT_TYPE;");
					sb.append("chr_no;");
					sb.append("chrom_start;");
					sb.append("chrom_stop");
					sb.append("\n");
					continue;
				}
				...
				if (rowCount == 80) {
					...
					File csvSampleFile = new File("C:/devel/workspace/cosmicRDFization/YasirCnvScript/src/main/resources/CNV.csv");
					FileUtils.writeStringToFile(csvSampleFile, sb.toString());
					break;
				}
				rowCount++;
			}
